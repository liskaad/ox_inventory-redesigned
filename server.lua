...
require 'lib.bridge.server'
require 'lib.core.crafting.server'
require 'lib.core.shops.server'
require 'lib.core.pefcl.server'
...
local db = require 'lib.core.mysql.server'
local Items = require 'lib.core.items.server'
local Inventory = require 'lib.core.inventory.server'
...
local Licenses = lib.load('config.licenses')
